export default function AboutIntellina() {
  return (
      ...
      <div className="about-box-inner">
        <div className="about-content">
          <p>
            ...
            <span className="highlight-text"> INTELLINA</span>.
          ...
          <p>
            ...
            just like scientists venturing into the <span className="upside-down-text">Upside Down</span>.
          </p>
